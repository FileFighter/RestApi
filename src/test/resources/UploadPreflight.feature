Feature: Upload Files Preflight
  ...
  Scenario: upload is possible, single file
    ...
    And the response contains a entity with the path "unterkünfte.avi" that has key "permissionIsSufficient" with value "true"
    And the response contains a entity with the path "unterkünfte.avi" that has key "nameAlreadyInUse" with value "false"
    And the response contains a entity with the path "unterkünfte.avi" that has key "nameIsValid" with value "true"
  ...
  Scenario: upload is possible, file in folder
    ...
    And the response contains a entity with the path "armee" that has key "permissionIsSufficient" with value "true"
    And the response contains a entity with the path "armee" that has key "nameAlreadyInUse" with value "false"
    And the response contains a entity with the path "armee" that has key "nameIsValid" with value "true"
  ...
  Scenario: name conflict folder and file
    ...
    And the response contains a entity with the path "gebäude" that has key "permissionIsSufficient" with value "true"
  ...
  Scenario: invalid Name file
    ...
    And the response contains a entity with the path "D[{~______~j}]D" that has key "nameIsValid" with value "false"
