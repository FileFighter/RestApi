...
#    When user with id "1234" and accessToken "accessToken1" searches user with search-value "penguin"
...
#    When user with id "1234" and accessToken "accessToken1" searches user with search-value " pen guin "
#    Then response status code is 200
#    And response contains the user with id 1235
#
#  Scenario: Failed to find another user because username has spelling errors
#    When user with id "1234" and accessToken "accessToken1" searches user with search-value "benguin"
...
#    When user with id "1234" and accessToken "accessToken1" searches user with search-value "bielefeld"
#    Then response status code is 404
